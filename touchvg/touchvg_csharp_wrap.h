...
public:
    ...
    typedef int (SWIGSTDCALL* SWIG_Callback34_t)();
    void swig_connect_director(SWIG_Callback0_t callbackclone, SWIG_Callback1_t callbackcopy, SWIG_Callback2_t callbackrelease, SWIG_Callback3_t callbackaddRef, SWIG_Callback4_t callbackequals, SWIG_Callback5_t callbackgetType, SWIG_Callback6_t callbackisKindOf, SWIG_Callback7_t callbackgetExtent, SWIG_Callback8_t callbackgetChangeCount, SWIG_Callback9_t callbackresetChangeCount, SWIG_Callback10_t callbackafterChanged, SWIG_Callback11_t callbackupdate, SWIG_Callback12_t callbacktransform, SWIG_Callback13_t callbackclear, SWIG_Callback14_t callbackclearCachedData, SWIG_Callback15_t callbackgetPointCount, SWIG_Callback16_t callbackgetPoint, SWIG_Callback17_t callbacksetPoint, SWIG_Callback18_t callbackisClosed, SWIG_Callback19_t callbackisCurve, SWIG_Callback20_t callbackhitTest, SWIG_Callback21_t callbackhitTestBox, SWIG_Callback22_t callbackdraw, SWIG_Callback23_t callbackoutput, SWIG_Callback24_t callbacksave, SWIG_Callback25_t callbackload, SWIG_Callback26_t callbackgetHandleCount, SWIG_Callback27_t callbackgetHandlePoint, SWIG_Callback28_t callbacksetHandlePoint, SWIG_Callback29_t callbackisHandleFixed, SWIG_Callback30_t callbackgetHandleType, SWIG_Callback31_t callbackoffset, SWIG_Callback32_t callbacksetFlag, SWIG_Callback33_t callbacksetOwner, SWIG_Callback34_t callbackgetSubType);
...
private:
    ...
    SWIG_Callback23_t swig_callbackoutput;
    ...
    SWIG_Callback33_t swig_callbacksetOwner;
    SWIG_Callback34_t swig_callbackgetSubType;
    void swig_init_callbacks();
};
...
public:
    ...
    typedef void (SWIGSTDCALL* SWIG_Callback33_t)(void *);
    typedef int (SWIGSTDCALL* SWIG_Callback34_t)();
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback35_t)(int);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback36_t)(void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback37_t)(int, void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback38_t)(int);
    void swig_connect_director(SWIG_Callback0_t callbackclone, SWIG_Callback1_t callbackcopy, SWIG_Callback2_t callbackrelease, SWIG_Callback3_t callbackaddRef, SWIG_Callback4_t callbackequals, SWIG_Callback5_t callbackgetType, SWIG_Callback6_t callbackisKindOf, SWIG_Callback7_t callbackgetExtent, SWIG_Callback8_t callbackgetChangeCount, SWIG_Callback9_t callbackresetChangeCount, SWIG_Callback10_t callbackafterChanged, SWIG_Callback11_t callbackupdate, SWIG_Callback12_t callbacktransform, SWIG_Callback13_t callbackclear, SWIG_Callback14_t callbackclearCachedData, SWIG_Callback15_t callbackgetPointCount, SWIG_Callback16_t callbackgetPoint, SWIG_Callback17_t callbacksetPoint, SWIG_Callback18_t callbackisClosed, SWIG_Callback19_t callbackisCurve, SWIG_Callback20_t callbackhitTest, SWIG_Callback21_t callbackhitTestBox, SWIG_Callback22_t callbackdraw, SWIG_Callback23_t callbackoutput, SWIG_Callback24_t callbacksave, SWIG_Callback25_t callbackload, SWIG_Callback26_t callbackgetHandleCount, SWIG_Callback27_t callbackgetHandlePoint, SWIG_Callback28_t callbacksetHandlePoint, SWIG_Callback29_t callbackisHandleFixed, SWIG_Callback30_t callbackgetHandleType, SWIG_Callback31_t callbackoffset, SWIG_Callback32_t callbacksetFlag, SWIG_Callback33_t callbacksetOwner, SWIG_Callback34_t callbackgetSubType, SWIG_Callback35_t callbackresize, SWIG_Callback36_t callbackaddPoint, SWIG_Callback37_t callbackinsertPoint, SWIG_Callback38_t callbackremovePoint);
...
private:
    ...
    SWIG_Callback33_t swig_callbacksetOwner;
    SWIG_Callback34_t swig_callbackgetSubType;
    SWIG_Callback35_t swig_callbackresize;
    SWIG_Callback36_t swig_callbackaddPoint;
    SWIG_Callback37_t swig_callbackinsertPoint;
    SWIG_Callback38_t swig_callbackremovePoint;
    void swig_init_callbacks();
};
...
public:
    ...
    typedef void (SWIGSTDCALL* SWIG_Callback33_t)(void *);
    typedef int (SWIGSTDCALL* SWIG_Callback34_t)();
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback35_t)(void *);
    void swig_connect_director(SWIG_Callback0_t callbackclone, SWIG_Callback1_t callbackcopy, SWIG_Callback2_t callbackrelease, SWIG_Callback3_t callbackaddRef, SWIG_Callback4_t callbackequals, SWIG_Callback5_t callbackgetType, SWIG_Callback6_t callbackisKindOf, SWIG_Callback7_t callbackgetExtent, SWIG_Callback8_t callbackgetChangeCount, SWIG_Callback9_t callbackresetChangeCount, SWIG_Callback10_t callbackafterChanged, SWIG_Callback11_t callbackupdate, SWIG_Callback12_t callbacktransform, SWIG_Callback13_t callbackclear, SWIG_Callback14_t callbackclearCachedData, SWIG_Callback15_t callbackgetPointCount, SWIG_Callback16_t callbackgetPoint, SWIG_Callback17_t callbacksetPoint, SWIG_Callback18_t callbackisClosed, SWIG_Callback19_t callbackisCurve, SWIG_Callback20_t callbackhitTest, SWIG_Callback21_t callbackhitTestBox, SWIG_Callback22_t callbackdraw, SWIG_Callback23_t callbackoutput, SWIG_Callback24_t callbacksave, SWIG_Callback25_t callbackload, SWIG_Callback26_t callbackgetHandleCount, SWIG_Callback27_t callbackgetHandlePoint, SWIG_Callback28_t callbacksetHandlePoint, SWIG_Callback29_t callbackisHandleFixed, SWIG_Callback30_t callbackgetHandleType, SWIG_Callback31_t callbackoffset, SWIG_Callback32_t callbacksetFlag, SWIG_Callback33_t callbacksetOwner, SWIG_Callback34_t callbackgetSubType, SWIG_Callback35_t callbackcanOffsetShapeAlone);
...
private:
    ...
    SWIG_Callback33_t swig_callbacksetOwner;
    SWIG_Callback34_t swig_callbackgetSubType;
    SWIG_Callback35_t swig_callbackcanOffsetShapeAlone;
    void swig_init_callbacks();
};
...
public:
    ...
    void swig_connect_director(SWIG_Callback0_t callbackonGetOptionBool, SWIG_Callback1_t callbackonGetOptionInt, SWIG_Callback2_t callbackonGetOptionFloat);
